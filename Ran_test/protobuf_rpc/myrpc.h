...
public:
    ...
    virtual void SetFailed(const std::string& resson) {}
    virtual bool IsCanceled() const { return false; }
    virtual void NotifyOnCancel(::google::protobuf::Closure* callback) {}
};

struct MyParam{
    ::google::protobuf::Message* _recv_msg;
    ::google::protobuf::Message* _resp_msg;
    const boost::shared_ptr<boost::asio::ip::tcp::socket> _sock;
    MyParam(::google::protobuf::Message* recv_msg, ::google::protobuf::Message* resp_msg,
    const boost::shared_ptr<boost::asio::ip::tcp::socket> sock):
            _recv_msg(recv_msg), _resp_msg(resp_msg), _sock(sock){}
};
...
private:
    void dispatch_msg(
            ...
            const boost::shared_ptr<boost::asio::ip::tcp::socket>& sock);
    void on_resp_msg_filled(MyParam *my_param);
...
void MyServer::dispatch_msg(
    ...
    MyParam my_param(recv_msg, resp_msg, sock);

    MyController controller;
    //WARNING: NewCallback不接受三个函数参数版本，将三个参数包装为一个结构体
...
//        const boost::shared_ptr<boost::asio::ip::tcp::socket> sock) {
        MyParam* my_param) {
    boost::scoped_ptr<::google::protobuf::Message> recv_msg_guard(my_param->_recv_msg);
    boost::scoped_ptr<::google::protobuf::Message> resp_msg_guard(my_param->_resp_msg);

    std::string resp_str;
    pack_message(my_param->_resp_msg, &resp_str);

    my_param->_sock->send(boost::asio::buffer(resp_str));
}
